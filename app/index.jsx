  ...
  return (
    <View className="h-screen relative  bg-[#FAD9CA]">
      ...
      <View className="flex items-center pt-3">
        <Text style={{fontFamily:'Inter',}} className="font-light text-3xl ">Connecting Farms</Text>
        <Text style={{fontFamily:'Inter',}} className="font-light text-3xl ">Feeding Families</Text>
      </View>
      ...
      <View className="flex justify-center items-center top-[80px]">
        <Text style={{fontFamily:'space',}}  className="underline font-normal">Terms Of Services</Text>
      </View>
